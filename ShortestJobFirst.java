 ...
 * 
 * The ShortestJobFirst class controls the scheduling of all
 * processes between the ReadyQueue, BlockedQueue, and CPU when
 * using the SJF algorithm. It records statistics about the
...
{
    private SJFReadyQueue readyQueue; 
    
    public ShortestJobFirst(String f) {
        filename = f;
        numJobs = 0;
